...
public class TestBnBPDTSP {
    ...
    void smallGraphOneRequest() {
        ...
        BnBPDTSP pdtsp = new BnBPDTSP(99999999, g, pred);
    ...
    void smallGraphOneRequestThreadVersionWithPause() {
        ...
        BnBPDTSP pdtsp = new BnBPDTSP(1, g, pred);
    ...
    void noGraphOutOfBounds() {
        BnBPDTSP pdtsp = new BnBPDTSP(99999999, null, null);
